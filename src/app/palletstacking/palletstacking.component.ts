...
@Component({
  selector: 'app-palletstacking',
  templateUrl: './palletstacking.component.html',
  styleUrls: ['./palletstacking.component.css']
})
export class PalletstackingComponent {
  [x: string]: any;
  ...
  deleteSelectedexsrvs(selectedexsrv:any)
  {
    this.confirmationService.confirm({
      ...
      accept: () => {
        ...
        param.entity = "Wrx_Palletstacking";
  ...
  savePallet()
  {
    ...
    if (this.Palletd.PalletStack && this.Palletd.PalletStack.trim()) 
    {
        if (this.Palletd.id) 
        {
          this.Pallets[this.findIndexById(this.Palletd.id)] = this.Pallets;
          this.Palletd.modifiedby = this.loggedinuser.Uid;
             ...
             if(this.rows.find((element:any)=>element.Pallet==this.Palletd.Pallet))
              {
                ...
                this.Palletd.createdby = this.loggedinuser.Uid;
