...
@Component({
  selector: 'app-rpt-allcontainers',
  templateUrl: './rpt-allcontainers.component.html',
  styleUrls: ['./rpt-allcontainers.component.css'],
  providers: [DialogService, MessageService]
})
export class RptAllcontainersComponent {
  constructor(   
  ...
  getContractSplits()
  {
    this.blockedPanel=true;
        ...
        let param: any = {};
        param.op = "query";
        param.query = "select * from vw_RailContainersbySplit;"//where ownerid=" + this.loggedinuser.Uid + ";";
