...
@Component({
  selector: 'app-rpt-dummy-dump',
  templateUrl: './rpt-dummy-dump.component.html',
  styleUrls: ['./rpt-dummy-dump.component.css'],
  providers: [DialogService, MessageService]
})
export class RptDummyDumpComponent {
  constructor(   
  ...
  getContractSplits()
  {
    this.blockedPanel=true;
        ...
        let param: any = {};
        param.op = "query";
        param.query = "select * from vw_DummyBatchContract;"//where ownerid=" + this.loggedinuser.Uid + ";";
        ...
        (res) => 
        {
          ...
          {        
            ...
            this.rows.forEach((DBC:any,index:number)=>{
              this.rows[index].CalcQuantity = Number(DBC.CalcQuantity);
  ...
  exportExcel()
  {
    import('xlsx').then((xlsx) => {
      ...
      this.saveAsExcelFile(excelBuffer, 'RailDumpFile');
  });
  }
