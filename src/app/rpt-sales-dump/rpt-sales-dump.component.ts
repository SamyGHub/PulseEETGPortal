...
@Component({
  ...
  selector: 'app-rpt-sales-dump',
  templateUrl: './rpt-sales-dump.component.html',
  styleUrls: ['./rpt-sales-dump.component.css'],
  providers: [DialogService, MessageService]
})
export class RptSalesDumpComponent {
  constructor(   
  ...
  getContractSplits()
  {
    this.blockedPanel=true;
        ...
        let param: any = {};
        param.op = "query";
        param.query = "select * from vw_QTYPlannedUsers;"//where ownerid=" + this.loggedinuser.Uid + ";";
  ...
  exportExcel()
  {
    import('xlsx').then((xlsx) => {
      ...
      this.saveAsExcelFile(excelBuffer, 'SalesDumpFile');
  });
  }
